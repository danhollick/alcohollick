...
- Part 4: <Link className="ext-link" href="/writing/2020-02-11-figma-plugin-tutorial-4-6">Working with Colours </Link> 👈 You are here
...
_The code for this section is [here](https://github.com/danhollick/zebra/tree/master/step2)._
