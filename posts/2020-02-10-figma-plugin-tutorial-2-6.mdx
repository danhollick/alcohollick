...
- Part 2: <Link className="ext-link" href="/writing/2020-02-10-figma-plugin-tutorial-2-6">How Figma Plugins Work.</Link> 👈 You are here
...
*Much of this is summarised from Figma’s own documentation, which is tremendous, so if you prefer you can read that* *[here](https://www.figma.com/plugin-docs/how-plugins-run/).*

*Also feel free to* **_skip to the next part_** *if you don’t care!*
...
![A diagram showing how the Figma plugin messaging system works.](/figma-plugin/part-2/figma_messaging.png)
...
![A diagram of a node tree data structure](/figma-plugin/part-2/node_tree.png)
...
![A screenshot of the Figma layers panel.](/figma-plugin/part-2/layers_panel.png)
...
Enough waffling, let’s write some plugin code 🎉: Part 3: <Link className="ext-link" href="/writing/2020-02-10-figma-plugin-tutorial-3-6"> Wiring Things Up </Link>
