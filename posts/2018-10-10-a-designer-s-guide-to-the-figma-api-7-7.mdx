...
- Part 7: <Link className="ext-link" href="/writing/2018-10-10-a-designer-s-guide-to-the-figma-api-7-7">Finishing up. </Link> 👈 You are here
  <hr />
...
![A screenshot of App.js](/figma-api/part-7/app_js.png)
...
![A screenshot of a browser window displaying an image from Figma](/figma-api/part-7/figma_image.png)
...
![A screenshot of a browser displaying four images from Figma](/figma-api/part-7/figma_four_images.png)
