...
description: 'Understanding the API.'
series: 'A designer’s guide to the Figma API'
part: 1
categories: ['tutorial']
hero: '/figma-api/hero.png'
---
...
- Part 1: <Link className="ext-link" href="/writing/2018-10-10-a-designer-s-guide-to-the-figma-api-1-7">Understanding the API.</Link> 👈 You are here
