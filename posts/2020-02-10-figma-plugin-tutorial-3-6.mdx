...
- Part 1: <Link className="ext-link" href="/writing/2020-02-10-figma-plugin-tutorial-1-6">Getting Started.</Link>
- Part 2: <Link className="ext-link" href="/writing/2020-02-10-figma-plugin-tutorial-2-6">How Figma Plugins Work.</Link>
- Part 3: <Link className="ext-link" href="/writing/2020-02-10-figma-plugin-tutorial-3-6"> Wiring Things Up </Link> 👈 You are here
- Part 4: <Link className="ext-link" href="/writing/2020-02-11-figma-plugin-tutorial-4-6">Working with Colours </Link>
- Part 5: <Link className="ext-link" href="/writing/2020-02-11-figma-plugin-tutorial-5-6">Working with the UI. </Link>
- Part 6: <Link className="ext-link" href="/writing/2020-02-11-figma-plugin-tutorial-6-6">Polishing Things Up. </Link>
  <hr />

_The code for this section is [here.](https://github.com/danhollick/zebra/tree/master/step1)_
...
For now, we aren’t going to update the UI. We are just going to check that the messages we get there are correct by logging them.

In the next chapter we are going to flesh out the functionality.
