...
description: 'Setting up a server.'
...
- Part 2: <Link className="ext-link" href="/writing/2018-10-10-a-designer-s-guide-to-the-figma-api-2-7">Setting up a server.</Link> 👈 You are here
