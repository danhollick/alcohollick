...
var validAttr = (function (name) {
  return hasOwnProperty$2.call(htmlProps, name) || hasOwnProperty$2.call(svgProps, name) || isCustomAttribute(name.toLowerCase()) || hasOwnProperty$2.call(reactProps, name);
});
...
export { css, keyframes, injectGlobal, ThemeProvider };export default styled;
