...
describe('preparsed flatten without executionContext', function () {
  ...
  it('flattens nested rulesets', function () {
    (0, _expect2.default)((0, _flatten2.default)([['a', [['c']], 'b']])).toEqual([['a', 'b'], ['c']]);
  });

  it('flattens double nested rulesets', function () {
    (0, _expect2.default)((0, _flatten2.default)([['a', [['c', [['d']]]], 'b']])).toEqual([['a', 'b'], ['c'], ['d']]);
  });
...
describe('preparsed flatten with executionContext', function () {
  it('merges strings', function () {
    (0, _expect2.default)((0, _flatten2.default)([['foo', 'bar', 'baz']], {})).toEqual(['foobarbaz']);
  });

  it('drops nulls', function () {
    // $FlowInvalidInputTest
    (0, _expect2.default)((0, _flatten2.default)([['foo', false, 'bar', undefined, 'baz', null]], {})).toEqual(['foobarbaz']);
  });

  it('doesnt drop any numbers', function () {
    (0, _expect2.default)((0, _flatten2.default)([['foo', 0, 'bar', NaN, 'baz', -1]], {})).toEqual(['foo0barNaNbaz-1']);
  });

  it('toStrings everything', function () {
    // $FlowInvalidInputTest
    (0, _expect2.default)((0, _flatten2.default)([[1, true]], {})).toEqual(['1true']);
  });
  ...
  it('flattens nested rulesets', function () {
    (0, _expect2.default)((0, _flatten2.default)([['a', [['c']], 'b']], {})).toEqual(['ab', 'c']);
  });

  it('flattens double nested rulesets', function () {
    (0, _expect2.default)((0, _flatten2.default)([['a', [['c', 'd', [['e', 'f'], ['g', 'h']]]], 'b']], {})).toEqual(['ab', 'cd', 'ef', 'gh']);
  });

  it('flattens subarrays', function () {
    (0, _expect2.default)((0, _flatten2.default)([[1, 2, [3, 4, 5], 'come:on;', 'lets:ride;']], {})).toEqual(['12345come:on;lets:ride;']);
  });
  ...
  it('executes functions', function () {
    ...
    (0, _expect2.default)((0, _flatten2.default)([['foo', func, 'baz']], {})).toEqual(['foobarbaz']);
  });
  ...
  it('resolves rulesets after executing functions', function () {
    ...
    (0, _expect2.default)((0, _flatten2.default)([['foo', func, 'baz']], {})).toEqual(['foobaz', 'add me to the end']);
  });
  ...
  it('resolves double nested rulesets after executing functions', function () {
    ...
    (0, _expect2.default)((0, _flatten2.default)([['foo', func, 'baz']], {})).toEqual(['foobaz', 'a', 'b']);
  });
});